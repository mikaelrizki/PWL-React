...
charlesImg.src = charles.allValues.avatar;
...
maryImg.src = mary.allValues.avatar;
...
janeImg.src = jane.allValues.avatar;
...
const { allValues, job } = charlesJobInfo;
...
// b. Tampilkan info dengan Template literals 
charlesJobInfoSelector.innerHTML = `${allValues.fullName} is a ${job}`;